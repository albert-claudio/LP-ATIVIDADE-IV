...
/** estoque - função para adicionar ou remover itens do inventário
 * @b: ponteiro para a estrutura de estoque
 * Esta função permite ao usuário adicionar ou remover itens do inventário.
 * O usuário pode optar por adicionar ou remover itens selecionando a opção apropriada.
 * A função solicita ao usuário o número de itens a serem adicionados ou removidos e atualiza
 * o inventário em conformidade.
 *
 * Retorno: o nível de estoque atualizado
 */
...
//--------------------------------
    ...
    system("clear || cls");
    printf("\no estoque de %s �: %i", components[0].name, stocksize[0]);
    printf("\no estoque de %s �: %i", components[1].name, stocksize[1]);
    printf("\no estoque de %s �: %i", components[2].name, stocksize[2]);
    return 0;
}